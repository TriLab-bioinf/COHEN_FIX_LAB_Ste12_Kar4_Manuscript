...
Folder [ChIP/](ChIP) contains scripts and helper files for ChIP-seq processing and analysis, including read alignment and preprocessing (e.g. `00_alignreads.sh`, `01_clean_count_bam.sh`), downstream analysis with CHEXmix (`02_chexmix.sh`), peak annotation and motif comparison scripts.
