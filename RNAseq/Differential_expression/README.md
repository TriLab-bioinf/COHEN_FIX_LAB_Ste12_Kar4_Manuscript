...
This folder contains an R Markdown script that generates a heatmap and a PCA plot from RNA-seq read-count data to assess sample relationships and quality.
