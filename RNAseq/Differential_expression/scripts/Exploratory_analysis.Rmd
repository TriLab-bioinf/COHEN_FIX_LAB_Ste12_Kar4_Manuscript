...
# INPUT files
read_counts_file <- "data/read_counts_table_all_samples.txt"
metadata_file <- "data/metadata.txt"

# Import read counts table into read_counts variable
read_counts <- read.table(file = read_counts_file,  
...
ggsave(filename = "./plots/heat_map.png", plot = hm.p, width = 8, height = 8)
...
ggsave(paste0("plots/pca_by_group_PC",principal_components[1],principal_components[2],".png"), plot = pca.p)
print(pca.p)
```
